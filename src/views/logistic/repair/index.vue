<template>
  <div class="repair-container">
    ...
    <popup-picker  class="floor-picker" :columns="floors()" label="楼层" placeholder="请选择楼层" @pick-confirm="floorPickCB"></popup-picker>

    <popup-picker class="floor-picker" :columns="equips()" label="故障设备" placeholder="门、洗手池..." @pick-confirm="equipPickCB"></popup-picker>
    ...
    <div class="img-picker">
      ...
      <van-uploader
          ...
          >
        <div class="img-btn">
          <van-button style="border-radius: 6px" square  icon="plus" size="mini" color="#6478d3"></van-button>
        </div>
      </van-uploader>
    </div>

    <div class="submit-btn">
      <van-button round  color="#6478d3" size="normal" @click="submitRepairSheet">提交</van-button>
    </div>
...
const equips = ()=>{
  ...
  arr.push({text:'门'},{text:'洗手池'},{text:'小便池'},{text:'蹲坑'},{text:'水管'})
  return arr
}
